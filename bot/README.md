...
| A | فرمان صوتی | ✅ STT اختیاری: **Vosk محلی آفلاین** یا `STT_URL`؛ بدون بک‌اند → صدا به صاحب‌مغازه + fallback محترمانه |
...
کل پایپ‌لاین آفلاین (اعداد/تقویم، parse فاکتور، انبار، تأیید فاکتور، یادآور، نردبان اعتبار، دروازه‌ی دسترسی، مسیر صوت، گزارش صبح، مسیرهای گفت‌وگو با Telegram mock) — باید `SELFTEST OK: 77/77` باشد.
