...
| C | دروازه‌ی دسترسی: فرمان‌های مالی/انباری فقط از چت مالک (اصل ۲ سرلوحه) | ✅ `/stats /pay /credit /balance /remind` قفل؛ مشتری → پاسخ محترمانه |
...
کل پایپ‌لاین آفلاین (اعداد/تقویم، parse فاکتور، انبار، یادآور، نردبان اعتبار، دروازه‌ی دسترسی، گزارش صبح، مسیرهای گفت‌وگو با Telegram mock) — باید `SELFTEST OK: 43/43` باشد.
