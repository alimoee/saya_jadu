...
کل پایپ‌لاین آفلاین (اعداد/تقویم، parse فاکتور، انبار، تأیید فاکتور، یادآور، نردبان اعتبار، دروازه‌ی دسترسی، گزارش صبح، مسیرهای گفت‌وگو با Telegram mock) — باید `SELFTEST OK: 72/72` باشد.
