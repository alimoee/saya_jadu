...
| D | یادآور موعد (نسیه/قبض) | ✅ `/remind` دقیقه‌ای یا تاریخ شمسی/میلادی + حلقه‌ی ارسال |
...
کل پایپ‌لاین آفلاین (اعداد/تقویم، parse فاکتور، انبار، یادآور، نردبان اعتبار، تاریخ شمسی، گزارش صبح، مسیرهای گفت‌وگو با Telegram mock) — باید `SELFTEST OK: 48/48` باشد.
...
/remind مشتری 1405-07-25 مبلغ نسیه آماده است   ← تاریخ شمسی
/remind مشتری 2026-10-17 مبلغ نسیه آماده است   ← یا میلادی
/reply 1234567410 سلام، فاکتورت آماده است
/credit علی 500000 1405-07-25 ← نسیه با سررسید شمسی (سقف: ۵۰۰۰۰۰۰۰؛ فراتر ← /approve)
